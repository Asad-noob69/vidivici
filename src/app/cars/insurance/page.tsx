      ...
      <div className="px-10 sm:px-16 lg:px-20 py-16 ">
        <div className="flex flex-col lg:flex-row-reverse gap-10 items-start">
          ...
          <div className="flex-1 max-w-lg">
            ...
            <button className="bg-mist-900 hover:bg-mist-700 transition-colors duration-200 text-white text-sm font-semibold px-6 py-3 rounded-md">
          ...
          <div className="flex-1 grid grid-cols-2 gap-3 w-full">
            {/* Top two images */}
            <div className="rounded-xl overflow-hidden h-40 sm:h-48 bg-mist-200">
              <img
            ...
            <div className="col-span-2 rounded-xl overflow-hidden h-44 sm:h-52 bg-mist-200">
              <img
      ...
      <div className="px-10 sm:px-16 lg:px-20 py-16">
        <div className="flex flex-col lg:flex-row items-center gap-10">
          ...
          <div className="flex-1 w-full">
            <div className="rounded-2xl overflow-hidden w-full h-64 sm:h-72 lg:h-80 bg-mist-100">
              <img
